                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li  onClick={() => { navigate("/") }} className="nav-item">
                                <a style={{ color: 'white' }} className="nav-link">Contact</a>
                            </li>
                            <li  onClick={() => { navigate("/") }} className="nav-item">
                    ...
                    {User? <button onClick={UserLogout}  type="button" className="btn" style={{color:'red'}}>Logut</button> :<button onClick={() => { navigate("/login") }}  type="button" className="btn btn">Login</button>}                
